...
console.log('Button 0 blue backlight should be on');
sleep.sleep(2);
xkeys.setBlueBackLight(0, false, false);
console.log('Button 1 blue backlight should be off');
sleep.sleep(2);
xkeys.setRedBackLight(0, true, false);
console.log('Button 0 red backlight should be on');
sleep.sleep(2);
xkeys.setRedBackLight(0, false, false);
console.log('Button 1 red backlight should be off');
sleep.sleep(2);
xkeys.close();
